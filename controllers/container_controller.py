...
def create_container(database_type: str, user : Annotated[UserInDB, Depends(get_current_user)]):
    database: Database = get_database_instance(database_type= database_type, database_list=DatabaseType)
...
def delete_container(container_id: str, user : Annotated[UserInDB, Depends(get_current_user)]):
...
def get_container(container_id: str, user : Annotated[UserInDB, Depends(get_current_user)]):
